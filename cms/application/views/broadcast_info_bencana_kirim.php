...
font-size: 16px;"> Selamat Datang <?php echo $username; ?> &nbsp; <a href="<?php echo site_url('login_control/logout');?>" class="btn btn-danger square-btn-adjust">Keluar</a> </div>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                    <?php echo form_open("pesan_control/broadcast_bencana"); ?>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <!-- Advanced Tables -->
                             Data Bencana Dipilih
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="bencana">
                                <!-- <table class="table table-striped table-bordered table-hover" id="dataTables-example"> -->
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $i = 0;
                                        if(!empty($bencana_dipilih))
                                        {
                                            foreach ($bencana_dipilih as $rows) { 
                                                $i++;
                                            ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $rows[0]->id_bencana; ?></td>
                                                <td><?php echo $rows[0]->nama_bencana; ?></td>
                                                <td><?php echo $rows[0]->jenis_bencana; ?></td>
                                                <td><?php echo $rows[0]->lokasi; ?></td>
                                                <td><?php echo $rows[0]->latitude; ?></td>
                                                <td><?php echo $rows[0]->longitude; ?></td>
                                                <td><?php echo $rows[0]->tanggal; ?></td>
                                                <td><?php echo $rows[0]->jam; ?></td>
                                                <td><?php echo $rows[0]->penyebab; ?></td>
                                            </tr>   
                                            <?php
                                            }
                                        }
                    ...
                    <!--End Advanced Tables -->
                    <input type="button" class="btn btn-primary" value="Batal" onclick="return checkBatalBroadcastBencana()"/>
                    <input type="submit" class="btn btn-default" value="Broadcast Data" onclick="return checkBroadcastBencana()"/>
    ...
    <script language="JavaScript" type="text/javascript">
        function checkBroadcastBencana(){
            return confirm('Anda yakin broadcast data bencana ini?');
        }
    </script>
    <script language="JavaScript" type="text/javascript">
        function checkBatalBroadcastBencana(){
            // return confirm('Anda yakin membatalkan broadcast data bencana ini?');
            var r = confirm("Anda yakin membatalkan broadcast data bencana ini?");
            if (r == true) {
                // txt = "You pressed OK!";
                window.location.href = "<?php echo site_url('pesan_control/view_broadcast_bencana');?>";
            } 
        }
    </script>   
</body>
