...
<head>
    ...
    <title>Pengelolaan Pesan - Broadcast Info Posko</title>
    <!-- BOOTSTRAP STYLES-->
...
font-size: 16px;"> Selamat Datang <?php echo $username; ?> &nbsp; <a href="<?php echo site_url('login_control/logout');?>" class="btn btn-danger square-btn-adjust">Keluar</a> </div>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                    <?php echo form_open("pesan_control/broadcast_posko_pilih_posko"); ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        if(!empty($data_posko))
                                        {
                                            foreach ($data_posko as $rows) { 
                                                $i++;
                                            ?>
                                            <tr>
                                                <td><input type="checkbox" value=<?php echo $rows->id_bencana; ?> name="posko[]"></td>
                                                <td><?php echo $rows->id_posko; ?></td>
                                                <td><?php echo $rows->id_bencana; ?></td>
                                                <td><?php echo $rows->nama_posko; ?></td>
                                                <td><?php echo $rows->latitude; ?></td>
                                                <td><?php echo $rows->longitude; ?></td>
                                                <td><?php echo $rows->lokasi_posko_dusun; ?></td>
                                                <td><?php echo $rows->lokasi_posko_kecamatan; ?></td>
                                                <td><?php echo $rows->lokasi_posko_kota; ?></td>
                                                <td><?php echo $rows->lokasi_posko_provinsi; ?></td>
                                            </tr>   
                                            <?php
                                            }
                                        }
