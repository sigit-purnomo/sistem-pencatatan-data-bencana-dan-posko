...
<head>
    ...
    <title>Pengelolaan Pesan - Pesan Masuk</title>
    <!-- BOOTSTRAP STYLES-->
...
font-size: 16px;"> Selamat Datang <?php echo $username; ?> &nbsp; <a href="<?php echo site_url('login_control/logout');?>" class="btn btn-danger square-btn-adjust">Keluar</a> </div>
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-sub-menu" href="<?php echo site_url('pesan_control');?>">Pesan Masuk</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Pengelolaan Pesan - Pesan Masuk</h2>    
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            foreach ($pesan_masuk as $rows) { 
                                                $i++;
                                                $x = 0;
                                            ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo date("d/m/Y h:ia",strtotime($rows['ReceivingDateTime'])); ?></td>
                                                <td><?php echo $rows['SenderNumber']; ?></td>
                                                <?php foreach ($daftar_petugas as $rows2 )
                                                if($rows2->no_hp == $rows['SenderNumber'])
                                                { ?>
                                                    <?php $x=1; ?>
    ...
    <script type="text/javascript">
      setInterval("my_function();",10000); 
        ...
        function my_function(){
            ...
            window.location.href = "<?php echo site_url('pesan_control');?>";
